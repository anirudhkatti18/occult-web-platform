  ...
  return (
    <div className="w-full max-w-7xl mx-auto px-6 relative z-10 flex flex-col font-sans">
      ...
      <section className="pt-32 md:pt-40 pb-16 md:pb-24">
        <h1 className="text-6xl md:text-8xl font-black leading-[0.9] tracking-tighter text-white max-w-5xl uppercase">
      ...
      <section className="mb-24">
        <div className="bg-white/5 border border-white/10 backdrop-blur-xl rounded-none p-8 md:p-12 mb-12">
      ...
      <section className="pb-32">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-1 md:gap-4">
          ...
          <div className="md:col-span-8 bg-white/5 border border-white/[0.08] backdrop-blur-xl rounded-none relative overflow-hidden group p-10 md:p-12 flex flex-col h-full min-h-[350px] transition-all duration-700 ease-in-out hover:-translate-y-2 hover:bg-white/10 hover:border-blue-500/50">
          ...
          <div className="md:col-span-4 bg-white/5 border border-white/[0.08] backdrop-blur-xl rounded-none relative overflow-hidden group p-10 md:p-12 flex flex-col h-full min-h-[350px] transition-all duration-700 ease-in-out hover:-translate-y-2 hover:bg-white/10 hover:border-blue-500/50">
